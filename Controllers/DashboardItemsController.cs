...
namespace portfolio_backend.Controllers
{
    ...
    public class DashboardItemsController : Controller
    {
        //GET api/values/5
        // [HttpGet("{id}")]
        ...
        // GET api/values
        [HttpGet()]
        public IEnumerable<DashboardItem> Get(string namespce)
        {
        ...
        // POST api/values
        [HttpPost]
        public long Post(string namespce, [FromBody]dynamic value)
        {
          if(!Authorized(namespce)) return -1;
          value = new DashboardItem(value);
          if(value.Id <= 0){
        ...
        // PUT api/values/5
        [HttpPut("{id}")]
        public void Put(string namespce, long id, [FromBody]dynamic value)
        {
        ...
        private Datastore<DashboardItem> GetDatastore(string namespce = "dylanvb"){
          return new Datastore<DashboardItem>("DashboardItem", namespce);
        }
